...
export interface KeyProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'color'> {
    color?: chroma.Color;
    selected?: boolean;
    hover?: boolean;
}
...
export const Key: React.FC<KeyProps> = ({ color, selected, hover, className, style, children, ...props }) => {
    ...
    return (
        <div
            className={mergeClasses(classes.key, selected && classes.selected, hover && classes.hover, className)}
